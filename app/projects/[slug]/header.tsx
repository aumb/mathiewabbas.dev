			...
			<div
				className={`fixed inset-x-0 top-0 z-50 backdrop-blur lg:backdrop-blur-none duration-200 border-b lg:bg-transparent ${
					isIntersecting
						...
						: "bg-zinc-900/500 border-zinc-800 lg:border-transparent"
				}`}
			>
				<div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
					<div className="flex justify-between gap-8">
						...
						<Link target="_blank" href="https://www.linkedin.com/in/mathiewabbas/">
							<Linkedin className="w-6 h-6 duration-200 hover:font-medium text-zinc-400 hover:text-zinc-100" />
						</Link>
						<Link target="_blank" href="https://github.com/aumb">
